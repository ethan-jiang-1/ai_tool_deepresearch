...
3. Assess each source; when verification requires page content, read and follow `shared-page-fetch-guidance.md`. This role does not maintain another fetch chain.
