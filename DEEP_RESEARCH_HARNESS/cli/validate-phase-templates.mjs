...
// Usage: node DEEP_RESEARCH_HARNESS/cli/validate-phase-templates.mjs [phase-file.md ...]
// Exit: 0 = PASS, 1 = FAIL
...
if (files.length === 0) {
  console.error('Usage: node DEEP_RESEARCH_HARNESS/cli/validate-phase-templates.mjs <phase-file.md...>');
  process.exit(1);
}
