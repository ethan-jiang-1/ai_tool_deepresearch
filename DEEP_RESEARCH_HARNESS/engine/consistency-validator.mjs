...
// @impl WNC-007
// Canonical engine location: DEEP_RESEARCH_HARNESS/engine/consistency-validator.mjs
//
// ## Role
 ...
 *
 * @param {object} opts
 * @param {string} [opts.workflowsDir] — path to workflows/ directory (default: DEEP_RESEARCH_HARNESS/workflows/)
 * @param {string} [opts.gateDefsDir] — path to gate definitions directory (default: DEEP_RESEARCH_HARNESS/schema/gate_definitions/)
...
export function validateWorkflowPackage(opts = {}) {
  ...
  const LIFECYCLE_INVENTORY = [
    ...
    { node: 'phases/phase-hitl1.md', surface: 'phase-agent', search_policy: 'direct_retrieval_probe_only', relay_capable: false },
  ...
  const VALID_SEARCH_POLICIES = ['no_search', 'capability_probe_only', 'direct_retrieval_probe_only', 'work_unit_required', 'work_unit_required_for_new_evidence', 'subagent_performs_search'];
