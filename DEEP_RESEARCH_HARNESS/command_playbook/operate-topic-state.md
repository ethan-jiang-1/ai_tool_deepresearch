...
```bash
node DEEP_RESEARCH_HARNESS/cli/operate-topic-state.mjs schema --context <hitl1|rerun|seed_topics|wave_projection>
```
...
```bash
node DEEP_RESEARCH_HARNESS/cli/operate-topic-state.mjs recover --bundle <bundle> --operation-id <id>
node DEEP_RESEARCH_HARNESS/cli/operate-topic-state.mjs inspect --bundle <bundle>
```
...
```bash
node DEEP_RESEARCH_HARNESS/cli/operate-topic-state.mjs apply --bundle <bundle> --input <retained-input.json>
```
