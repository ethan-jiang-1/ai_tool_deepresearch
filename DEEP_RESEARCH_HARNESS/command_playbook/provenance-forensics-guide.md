...
- Work-unit envelopes live under the current run bundle root at `_work_units/waveN/{work_id}/`.
...
2. Run `node DEEP_RESEARCH_HARNESS/cli/operate-work-unit.mjs inspect <bundle>` and read drift, expired, orphan, transaction, and projection diagnostics.
