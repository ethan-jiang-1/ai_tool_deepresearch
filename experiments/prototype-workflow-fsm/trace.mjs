// trace.mjs — workflow-fsm 实验痕迹系统
// 复用 gate-loop/gate-fork/workflow-next API，trace source 前缀使用 wfsm-
//
// 用法:
//   setTraceFile('dpt_disp_wfsm_simple/_trace_wfsm_simple.jsonl')
//   traceInit('workflow-fsm simple test')
//   traceEntry('advance_start', { source: 'wfsm', step: 'entry.md' })
//   traceSummary()
//   traceCleanup()
