...
// @impl EXS-002: Canonical location experiments/shared/new-disposable-bundle.mjs
...
// Parse args: supports --nodes <dir> and --nodes=<dir>
const args = process.argv.slice(2);
const bundleName = args[0];
let nodesDir = null;
for (const a of args) {
  if (a === '--nodes') { nodesDir = args[args.indexOf(a) + 1]; break; }
  if (a.startsWith('--nodes=')) { nodesDir = a.slice('--nodes='.length); break; }
}
