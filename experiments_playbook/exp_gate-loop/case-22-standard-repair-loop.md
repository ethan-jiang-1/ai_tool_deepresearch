...
bundle: dpt_disp_case-22_gl_medium
trace: dpt_disp_case-22_gl_medium/_logs/_logs/_trace.jsonl
verdict: trace-jsonl
---
...
```bash
B=$(node experiments_env/shared/new-disposable-bundle.mjs gl_medium --case case-22 --force)
