...
case: wave1-batch-subagent-happy-path
weight: heavy
...
bundle: dpt_disp_agql_w1_simple_
trace: dpt_disp_agql_w1_simple_*/_trace.jsonl
verdict: trace-jsonl
req: WAI-006
---
...
# test-simple-wave1-batch-subagent
...
```bash
REPO_ROOT=$(pwd)
B=$(node experiments/shared/new-disposable-bundle.mjs agql_w1_simple --force)
echo "Bundle: $B"
