...
case_goal: "Prove the HITL1 gate accepts a complete claim_verification profile and routes to Setup."
verdict_mode: all
required_checks: [profile-claim-verification, hitl1-recorded]
...
# Case 105 - Claim-Verification HITL1
