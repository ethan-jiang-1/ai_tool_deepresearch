...
node -e "import('$REPO_ROOT/experiments_env/shared/wff-playbook-utils.mjs').then(m=>{m.recordCheck('$B/_trace.jsonl',{gate:'instantiation-complete',passed:$PASSED,detail:'production path: instantiate-run-bundle.mjs'})})"
```
