...
trace: dpt_disp_case-951_wff_rwa_*/_trace.jsonl
verdict: trace-jsonl
---
...
node -e "import('$REPO_ROOT/experiments_env/shared/wff-playbook-utils.mjs').then(m=>{m.recordCheck('$B/_trace.jsonl',{gate:'human-review',passed:'$AI_VERDICT'==='pass',detail:'source: ai-judge — AI reviewer verdict (dual of case-901 human verdict); NOT a human verdict'})})"
