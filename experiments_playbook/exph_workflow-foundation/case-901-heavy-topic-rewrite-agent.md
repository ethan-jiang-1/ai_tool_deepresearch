...
trace: dpt_disp_case-901_wff_rwa_*/_logs/_logs/_trace.jsonl
verdict: trace-jsonl
---
...
node -e "import('$REPO_ROOT/experiments_env/shared/wff-playbook-utils.mjs').then(m=>{m.recordCheck('$B/_logs/_logs/_trace.jsonl',{gate:'human-review',passed:'$HUMAN_VERDICT'==='pass',detail:'source: human — rewrite quality verdict by reviewer'})})"
