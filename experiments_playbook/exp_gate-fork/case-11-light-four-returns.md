...
trace: dpt_disp_case-11_gf_simple/_trace.jsonl
verdict: trace-jsonl
---
...
```bash
B=$(node experiments_env/shared/new-disposable-bundle.mjs gf_simple --case case-11 --force)
