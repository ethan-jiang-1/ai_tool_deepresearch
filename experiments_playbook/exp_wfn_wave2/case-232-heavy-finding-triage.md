...
trace: dpt_disp_case-232_agql_w2_triage_*/_trace.jsonl
verdict: trace-jsonl
...
node -e "import('$REPO_ROOT/experiments_env/shared/wff-playbook-utils.mjs').then(m=>{m.recordCheck('$B/_trace.jsonl',{gate:'wave2-complete',passed:$PASSED,detail:'finding triage: 1 resolution + 1 emergent + 1 exploit_search, no orphan'})})"
```
