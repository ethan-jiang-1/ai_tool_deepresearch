...
node DEEP_RESEARCH_HARNESS/cli/log-event.mjs --bundle "$B" --surfacing-intent --node phases/phase-wave1.md --intent-type progress_report --reason "would report repeated gate failures to the user"
echo "BUNDLE=$B"
```
