...
本 playbook 是 `exp_workflow-foundation/case-901-heavy-topic-rewrite-agent.md` 的 **AI 扮演真人对偶**（9NN +50 配对：901 真人 ↔ 951 AI，见 `experiments_playbook/README.md` § 编号约定）。
...
- **自动可跑**：901 已移除；951 在 `exp_`、自动可跑，让人类判断机制不阻塞 pipeline。
...
> 951（exp_，自动可跑）—— 901（已移除）的 AI 扮演 dual。
