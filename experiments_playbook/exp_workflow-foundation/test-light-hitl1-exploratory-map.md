...
case: light-hitl1-exploratory-map
weight: light
...
bundle: dpt_disp_wff_em_*
trace: dpt_disp_wff_em_*/_trace.jsonl
verdict: trace-jsonl
---
...
# test-workflow-foundation-hitl1-exploratory-map
...
node -e "import('$REPO_ROOT/experiments/shared/wff-playbook-utils.mjs').then(m=>{m.recordCheck('$B/_trace.jsonl',{gate:'hitl1-recorded',passed:$PASSED,detail:'exploratory_map payload'})})"
```
