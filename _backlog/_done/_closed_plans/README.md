...
| CLS-036 | 2026-07-26 | delegated-work-operability-and-gate-truth.md | BUG-114–123 的归因与收敛完成：两个 OpenSpec change archive，queue/Gate 候选均无 fresh red；BUG-120 的真实内容证据保留为独立 active `NOT_RUN`，不阻塞本计划关闭 |
