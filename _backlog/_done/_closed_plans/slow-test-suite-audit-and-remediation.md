...
- [ ] **WS7 — gate/queue matrix P3** — PART 1 (wave0/wave2/readiness/hitl2 + operate-queue-validation shared empty-bundle; ~50s file-level) DONE 2026-08-22 (archived `2026-08-22-share-gate-matrix-bundle-baselines`); PART 2 (hitl1-recorded per-leaf CLI cost; agent-experiment-autorun) PENDING.
