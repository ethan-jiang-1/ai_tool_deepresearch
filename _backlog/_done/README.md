...
> 最后更新: 2026-08-10 | `_backlog/_done/` — 所有已完成内容与已吸收设计输入的归档根目录。
...
├── _done_todos/           # 已完成 TODO（16 个，DONE-001~016）+ 已吸收 standalone TODO（4 个）
...
| `_done_todos/` | 16 个已完成 todo（DONE-001~016）+ 4 个已吸收设计输入（非实现） | DONE-017 |
| `_closed_plans/` | 57 个已完成 plan | CLS-057 |
