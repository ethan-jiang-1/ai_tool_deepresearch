...
> 最后更新: 2026-08-11 | `_backlog/_done/` — 所有已完成内容、已吸收设计输入与已替代历史 TODO 的归档根目录。
...
├── _fixed_bugs/           # 已修复/结案 Bug（187 个，含间隔）
...
| 归档目录 | 数量 | Next ID |
|---------|------|---------|
| `_fixed_bugs/` | 187 个已修复/结案 bug（含间隔） | BUG-212 |
...
| `_closed_plans/` | 58 个已完成 plan | CLS-058 |
