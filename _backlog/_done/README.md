...
> 最后更新: 2026-08-17 | `_backlog/_done/` — 所有已完成内容、已吸收设计输入与已替代历史 TODO 的归档根目录。
...
├── _fixed_bugs/           # 已修复/结案 Bug（205 个，含间隔）
...
| 归档目录 | 数量 | Next ID |
|---------|------|---------|
| `_fixed_bugs/` | 205 个已修复/结案 bug（含间隔） | BUG-232 |
...
| `_closed_plans/` | 69 个已完成 plan | CLS-070 |
