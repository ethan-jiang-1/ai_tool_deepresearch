...
├── _closed_plans/         # 已完成 Plan（15 个，CLS-001~015）
...
| `_closed_plans/` | 15 个已完成 plan（CLS-001~015） | CLS-016 |
...
### 想看"现在该做什么"
→ [`../todos/README.md`](../todos/README.md) 的"推荐执行顺序"——**BUG-069~075 批次已修复归档（2026-07-11）；当前：coding-agent-setup-ux，其次收窄后的 evidence-quality**
