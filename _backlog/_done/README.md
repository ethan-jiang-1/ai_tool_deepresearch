...
> 最后更新: 2026-08-15 | `_backlog/_done/` — 所有已完成内容、已吸收设计输入与已替代历史 TODO 的归档根目录。
...
├── _fixed_bugs/           # 已修复/结案 Bug（198 个，含间隔）
...
| `_closed_plans/` | 65 个已完成 plan | CLS-066 |
