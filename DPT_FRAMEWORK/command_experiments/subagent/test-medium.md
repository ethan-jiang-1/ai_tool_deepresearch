...
Two real LLM subagents through Parent Relay. Bundle: `dpt_rb_test_gs_medium/`, trace: `_trace_gs_medium.jsonl`.

This playbook verifies parallel spawn request semantics before collect: `dpt-source-intake` and `dpt-source-diagnostic`.
