...
const sharedEvaluation = evaluateWave0Contract(bundlePath, definition, { topicRegistryFact });
const projectionEvaluation = evaluateSeedTopicProjectionReadiness(bundlePath, { wave: 'wave0', topicRegistryFact });
