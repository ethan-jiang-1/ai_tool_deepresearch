...
This convention matches `DPT_FRAMEWORK/COMMANDS.md`: exit codes are coarse control-flow signals, while stdout JSON / structured output is the Agent's actionable decision surface.
