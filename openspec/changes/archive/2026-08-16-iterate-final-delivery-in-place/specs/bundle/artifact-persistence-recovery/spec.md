...
- FROM: `### Requirement: Final Markdown persistence SHALL admit submitted backing before durability commit`
- TO: `### Requirement: Final Markdown publication SHALL admit backing and protect the primary version series`
