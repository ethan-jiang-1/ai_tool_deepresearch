...
- **THEN** selection SHALL 以 retained current-v2 history 导出的确定性轮转跨 group 取样
...
- **WHEN** 一个新 case 没有 current-v2 duration/cost observation 且其 filename cost 的 initial estimate 能装入显式 bounds
