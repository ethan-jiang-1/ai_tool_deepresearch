...
- explicit late-submit may accept an eligible timed-out original;
...
- **WHEN** a controlled case has a timed-out original with valid original result surfaces
...
- **THEN** explicit late-submit for the original SHALL reject
