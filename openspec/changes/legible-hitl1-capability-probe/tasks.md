...
- [ ] 1.1 `openspec-feedback:plan-review` (CHF-001, CHF-002) Review the
...
- [ ] 1.2 Run `node openspec/governance/check-verification-routing.mjs --change
...
- [ ] 1.3 Recheck the current `phase-hitl1.md`, `brief/hitl1.md`,
...
- [ ] 2.1 Implement HIU-002 in `DPT_FRAMEWORK/workflows/nodes/brief/hitl1.md`.
...
- [ ] 2.3 Update `CONTEXT.md` under Interaction Model for PRP-002/HIU-002. Add
...
- [ ] 3.1 Extend `tests/integration/md/phase-hitl1-research-access.test.mjs`
...
- [ ] 3.2 Run `node --test tests/integration/md/phase-hitl1-research-access.test.mjs`
...
- [ ] 3.3 Release the implemented framework as v0.72 by updating
...
- [ ] 4.1 After focused verification passes, update BUG-187 and the C4 rows in
  ...
  real-Agent behavior.
- [ ] 4.2 Use the supported OpenSpec spec-sync operation to merge the approved
...
- [ ] 4.3 Run `openspec validate legible-hitl1-capability-probe --strict` and
...
- [ ] 4.4 Run `node openspec/governance/check-project-specs.mjs` and
...
- [ ] 5.1 `openspec-feedback:closeout-review` (CHF-001, CHF-002) Review the
