...
- **WHEN** a Wave1 topic reference file exists but its source URL cannot be tied to submitted Wave1 source claims, cache trails, or explicit degraded-capture backing
