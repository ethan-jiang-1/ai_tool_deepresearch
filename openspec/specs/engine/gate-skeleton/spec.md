...
> req: GSK-001, GSK-002, GSK-003, GSK-004, GSK-005, GSK-006, GSK-007, GSK-008, GSK-009, GSK-010, GSK-011, GSK-012, GSK-013
...
- **THEN** agent MUST 调用 `node DEEP_RESEARCH_HARNESS/cli/gates/check-gate-wave0-complete.mjs --bundle <path>`，MUST NOT 调用一个 generic runner 加 `--gate wave0-complete` 参数
