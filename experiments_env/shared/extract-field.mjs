...
//
// Usage:
//   echo "$GATE_OUTPUT" | node experiments_env/shared/extract-field.mjs check.passed
//   echo "$GATE_OUTPUT" | node experiments_env/shared/extract-field.mjs routing.kind
